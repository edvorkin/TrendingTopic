...
import com.edvorkin.tools.SlidingWindowCounter;
import org.apache.log4j.Logger;
import com.edvorkin.tools.NthLastModifiedTimeTracker;
...
public class RollingCountBolt extends BaseRichBolt {
    ...
    public void execute(Tuple tuple) {
       /* System.out.print(tuple);
        ...
        if(!counters.containsKey(articleId)){
            counters.put(articleId, 1);
        }else{
